...
| **[`VGA_CAM_Project`](https://github.com/junbro0608/VGA_CAM_Project)** | FPGA / Vision | • 6대 카메라 및 다중 FPGA(Basys3) 간 SPI/I2C 연동<br>• YCoCg 2:1 압축 및 핑퐁(Double Buffering) 메모리 제어 | • 모자이크 2X3 영상 합성 및 12-bit 음계 검출 시스템 구현 |
